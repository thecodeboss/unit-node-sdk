...
export class Payments extends BaseResource {
    ...
    public async bulkCreate(requests: CreatePaymentRequest[]): Promise<UnitResponse<BulkPayments>> {
        return this.httpPost<UnitResponse<BulkPayments>>("/bulk", { data: requests })
    }
